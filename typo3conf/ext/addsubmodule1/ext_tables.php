<?php
/**
 * This file is part of the TYPO3 CMS Extension "Add Submodule 1"
...
if (TYPO3_MODE === 'BE' && !(TYPO3_REQUESTTYPE & TYPO3_REQUESTTYPE_INSTALL)) {
    ...
    \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
		...
		'addsubmodule1',				// sub module name
		'',								// position
        array(),
        array(
            'access' => 'user,group',
            'icon'   => 'EXT:' . $_EXTKEY . '/ext_icon.gif',
			'labels' => 'LLL:EXT:' . $_EXTKEY . '/Resources/Private/Language/locallang.addsubmodule1.xlf',
        )
    );
